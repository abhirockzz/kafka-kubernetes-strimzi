...
var (
	bootstrapServers, caLocation, topic, kafkaScramUsername, kafkaScramPassword string
	kp                                                                          *kafka.Producer
	kc                                                                          *kafka.Consumer
)
...
func init() {
	...
	consumerConfig := &kafka.ConfigMap{"bootstrap.servers": bootstrapServers, "security.protocol": "SASL_SSL", "ssl.ca.location": caLocation, "sasl.mechanism": "SCRAM-SHA-512", "sasl.username": kafkaScramUsername, "sasl.password": kafkaScramPassword, "group.id": "strimzi-tls-test-consumer-group"}
